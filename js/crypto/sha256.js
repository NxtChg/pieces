...
function SHA256(s, uppercase) // 's' can be a string, Uint8Array or regular JS array
{
	...
	function bin2hex(b) // b is an array of 32-bit integers
	{
		var str = '', hex = (uppercase ? '0123456789ABCDEF' : '0123456789abcdef');

		for(var i = 0; i < (b.length << 2); i++)
		{
			str += hex.charAt((b[i>>2] >> (28 - ((i&3)<<3))) & 0xF) +
			       hex.charAt((b[i>>2] >> (24 - ((i&3)<<3))) & 0xF);
		}
	...
	return bin2hex(core_sha256((typeof(s) == 'string' ? read_str : read_bytes), last+1));
}
